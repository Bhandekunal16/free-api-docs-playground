...
export type EndpointCategory = 'health' | 'fake' | 'mock' | 'geography' | 'weather' | 'pokemon' | 'rick-and-morty' | 'cat-facts' | 'dogs' | 'jikan' | 'coingecko' | 'ipify' | 'agify' | 'genderize' | 'nationalize' | 'github' | 'open-library' | 'gutendex' | 'meal-db' | 'cocktail-db' | 'joke-api' | 'official-joke' | 'random-user' | 'bored' | 'deck-of-cards' | 'chess' | 'open-food-facts';
