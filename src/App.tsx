      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <main className="flex-1 lg:pl-72 flex flex-col min-w-0 overflow-y-auto">
          {isDocSection ? (
            ...
            <div className="flex-1 flex flex-col 2xl:flex-row min-w-0 divide-y 2xl:divide-y-0 2xl:divide-x divide-slate-800">
              ...
              {(layoutMode === 'split' || layoutMode === 'playground') && (
                <div
                  className={`flex-1 overflow-y-auto bg-slate-900/40 ${
                    layoutMode === 'split' ? '2xl:max-w-[50%]' : 'w-full'
                  }`}
                >
